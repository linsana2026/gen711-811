...
grep AAGTT SRR098026.fastq 

grep AAGTT SRR097977.fastq 
...
The only difference when matching in one file vs. both files are the number of results that come out in the output.
...
There are about 180 sequences in this .fastq file
