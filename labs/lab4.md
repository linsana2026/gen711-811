...
file-c-prog.txt  headerlines.txt  SRR097977.fastq  SRR098026.fastq
...
My line number witn the .sh files in usr/bin were both ##171 and ##172, since the first one was an error.
